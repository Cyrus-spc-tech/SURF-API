...
@router.post("", summary="Predict insurance premium", description="Predict insurance premium based on user input")
def predict_prs(data: UserInput):
    ...
    return JSONResponse(status_code=200, content={"prediction_value": predicted[0]})
